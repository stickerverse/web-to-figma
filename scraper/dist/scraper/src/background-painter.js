 ...
 */
export function parseBackground(styles, imageAssets) {
    if (!styles)
        return null;
    const layers = [];
 ...
 */
function parseBackgroundImages(backgroundImage, styles, imageAssets) {
    const layers = [];
 ...
 */
function parseBackgroundColor(backgroundColor, styles) {
 ...
 */
function parseBackgroundImageLayer(imageDecl, imageAssets) {
...
// Helper functions
function splitBackgroundImages(backgroundImage) {
    const images = [];
    let current = '';
    let depth = 0;
    let inQuotes = false;
...
function splitColorStops(stopsString) {
    const stops = [];
    let current = '';
    let depth = 0;
    let inQuotes = false;
...
function getArrayValue(array, index, defaultValue) {
...
function parseColorComponent(component) {
